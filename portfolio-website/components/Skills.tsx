  ...
  return (
    <section id="skills">
      <div className="max-w-[1200px] mx-auto mb-30 px-4 md:px-8 text-center">
        <h2 className="inline-block mx-auto mb-20 bg-linear-to-r from-fuchsia-600 to-sky-500 bg-clip-text text-transparent text-6xl leading-15 tracking-wide">Skills</h2>
        <div className="grid grid-cols-5 gap-10 justify-items-center">
          ...
          <Image src={javascript} width={100} height={100} alt="javascript icon" />
          <Image src={typescript} width={100} height={100} alt="typescript icon" />
